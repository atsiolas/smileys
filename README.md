...
> Άνοιγμα αυτής της σελίδας στο [https://atsiolas.github.io/smileys/](https://atsiolas.github.io/smileys/)
...
* αναζήτηση για **https://github.com/atsiolas/smileys** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/atsiolas/smileys/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/atsiolas/smileys** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/atsiolas/smileys/raw/master/.github/makecode/blocks.png)
